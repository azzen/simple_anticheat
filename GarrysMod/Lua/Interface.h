...
struct lua_State
{
    ...
    GarrysMod::Lua::ILuaBase* luabase;
        ...
        #define GMOD_MODULE_OPEN()                                 \
            int gmod13_open__Imp( GarrysMod::Lua::ILuaBase* LUA, lua_State* L ); \
            DLL_EXPORT int gmod13_open( lua_State* L )             \
            {                                                      \
                return gmod13_open__Imp( L->luabase, L );          \
            }                                                      \
            int gmod13_open__Imp( GarrysMod::Lua::ILuaBase* LUA, lua_State* L )
        ...
        #define LUA_FUNCTION( FUNC )                          \
            int FUNC##__Imp( GarrysMod::Lua::ILuaBase* LUA, lua_State* L ); \
            int FUNC( lua_State* L )                          \
            {                                                 \
                GarrysMod::Lua::ILuaBase* LUA = L->luabase;   \
                LUA->SetState(L);                             \
                return FUNC##__Imp( LUA, L );                 \
            }                                                 \
            int FUNC##__Imp( GarrysMod::Lua::ILuaBase* LUA, lua_State* L )
    #endif
#endif
